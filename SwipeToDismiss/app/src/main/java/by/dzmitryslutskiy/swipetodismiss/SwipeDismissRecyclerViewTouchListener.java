...
public class SwipeDismissRecyclerViewTouchListener implements View.OnTouchListener {
    ...
    public interface DismissCallbacks {
        ...
        void onDismissRight(View mRootView, boolean dismissRight);
    }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        switch (motionEvent.getActionMasked()) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mDownView != null && mRootView != null) {
                    mDownX = motionEvent.getRawX();
                    mDownY = motionEvent.getRawY();
                    mDownPosition = mRecyclerView.getChildPosition(mRootView);
    ...
    private void performDismiss(final View dismissView, final int dismissPosition) {
        ...
        if (mDismissAnimationRefCount == 0) {
            ...
            for (PendingDismissData pendingDismiss : mPendingDismisses) {
                ...
                pendingDismiss.view.setVisibility(View.INVISIBLE);
            }
